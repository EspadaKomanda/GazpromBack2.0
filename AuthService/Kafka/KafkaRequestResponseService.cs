...
namespace BackGazprom.Kafka;

public class KafkaRequestResponseService
{
    
    private readonly IProducer<string, string> _producer;
    private readonly ILogger<KafkaRequestResponseService> _logger;
    private readonly KafkaTopicManager _kafkaTopicManager;
    public KafkaRequestResponseService(IProducer<string,string> producer, ILogger<KafkaRequestResponseService> logger, KafkaTopicManager kafkaTopicManager)
    {
        _producer = producer;
        _logger = logger;
